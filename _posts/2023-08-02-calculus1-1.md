...
The following figure is a graph of \\(y=sin({\pi \over x})\\). It looks like have a limit value of \\(0\\) at \\(x=0\\). However, as \\(x\\) gets infinitely closer to \\(0\\), the value of \\(y\\) infinitely oscillates between \\(-1\\) and \\(1\\). It means the function is not approaching specific point, so it does not have a limit at \\(x=0\\).
...
The following figure is a graph of \\(y=tan(x)\\). Figure (a) represents the case that \\(x\\) approaches \\({\pi \over 2}\\), and (b) represents the case that \\(x\\) approaches \\(-{\pi \over 2}\\).
...
In the case (a), as \\(x\\) approaches \\({\pi \over 2}\\), the function value increases infinitely, denoted as \\(\lim_{x\rightarrow {\pi \over 2}} tan(x)=\infty\\).

Conversely, in case (b), as \\(x\\) approaches \\(-{\pi \over 2}\\), the function value decreases infinitely, denoted as \\(\lim_{x\rightarrow -{\pi \over 2}} tan(x)=- \infty\\).
